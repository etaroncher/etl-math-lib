...
namespace ETL::Math
{
    ...
    /// Vector3
    template bool isZero(const Vector3<int>&,    int);
    template bool isZero(const Vector3<float>&,  float);
    template bool isZero(const Vector3<double>&, double);

    template bool isEqual(const Vector3<int>&,    const Vector3<int>&,    int);
    ...
    /// Vector4
    template bool isZero(const Vector4<int>&,    int);
    template bool isZero(const Vector4<float>&,  float);
    template bool isZero(const Vector4<double>&, double);

    template bool isEqual(const Vector4<int>&,    const Vector4<int>&,    int);
    template bool isEqual(const Vector4<float>&,  const Vector4<float>&,  float);
    template bool isEqual(const Vector4<double>&, const Vector4<double>&, double);

    /// Matrix3x3
    template bool isZero(const Matrix3x3<int>&,    int);
    template bool isZero(const Matrix3x3<float>&,  float);
    template bool isZero(const Matrix3x3<double>&, double);

    template bool isEqual(const Matrix3x3<int>&,    const Matrix3x3<int>&,    int);

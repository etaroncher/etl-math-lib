...
namespace ETL::Math
{
    ...
    template void Dot(float&  outResult, const Vector3<float>&  v1, const Vector3<float>&  v2);
    template void Dot(double& outResult, const Vector3<double>& v1, const Vector3<double>& v2);
    template void Dot(int&    outResult, const Vector3<int>&    v1, const Vector3<int>&    v2);
